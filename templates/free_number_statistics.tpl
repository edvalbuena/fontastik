<div>
    ...
    <div class="onnet-pager">
        <div style="display: inline-block;" id="addnumbertorderform"><a style="color: #fff; background-color: #E86110; text-decoration: none;" href="#">{_ Add number to order _}</a></div>
        <div style="display: inline-block;" id="chooseanothernumber"><a style="color: #fff; background-color: #3E7A8C; text-decoration: none;" href="#">{_ Choose another number _}</a></div>
    </div>
