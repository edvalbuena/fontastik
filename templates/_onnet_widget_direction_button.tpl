...
<ul class="dropdown-menu nav-list nav">
    ...
    <li><a href="#" onclick="$('#callsdirection').val('0'); $('#direction_text').text('{_ Inbound calls _}');$('#callstype').val('1017,881,6,1'); $('#callstype_text').text('{_ All _}');">{_ Inbound calls _}</li></a>
