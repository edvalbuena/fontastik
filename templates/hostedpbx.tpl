...
<h4>{_ Important info _}</h4>
	...
	Мы реализуем данную услугу на свободном ПО <a target="_blank" href="http://www.freepbx.org">FreePBX</a>, что позволяет Вам, при надлежащем опыте и желании, самостоятельно администрировать систему; позволяет осуществлять интеграцию с различными CRM системами (например <a target="_blank" href="https://novacrm.ru">NovaCRM</a>); избавляет Вас от лицензионных платежей.
