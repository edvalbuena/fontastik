...
<ul>
    <li>
    	<label class="radio"><input id="crmvpbx" type="radio" name="virtualservertype" value="crmvpbx" title="CRM">
    ...
    <li>
    	<label class="radio"><input id="windowsserver" type="radio" name="virtualservertype" value="Windows" title="Windows">
