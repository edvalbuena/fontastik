...
{% block widget_headline %}
    {{ headline }}
    {% if not m.onnet[{get_docs_list docsids="39" month=selectedmonth }] %} {% button class="btn btn-xs btn-onnet pull-right" action={postback postback="callsreportme_progress" delegate="onnet"} action={postback postback="callsreportme" delegate="onnet" qarg="docsmonthInput"} text=_"generate" %} {% endif %}
{% endblock %}
