...
{% block widget_headline %}
    {{ headline }}
    {% button class="btn btn-xs btn-onnet pull-right" action={postback postback="refresh_invoices" delegate="onnet" qarg="docsmonthInput"} action={postback postback="refresh_vatinvoices" delegate="onnet" qarg="docsmonthInput"} action={postback postback="refresh_acts" delegate="onnet" qarg="docsmonthInput"} action={postback postback="refresh_calls_reports" delegate="onnet" qarg="docsmonthInput"} text=_"refresh results" %}
{% endblock %}
