...
<ul class="dropdown-menu nav-list nav">
    ...
    <li><a href="#" onclick="$('#callstype').val('881,6,1'); $('#callstype_text').text('{_ All _}');">{_ All _}</li></a>
    <li><a href="#" onclick="$('#callstype').val('1'); $('#callstype_text').text('{_ Local calls _}');">{_ Local calls _}</li></a>
    <li><a href="#" onclick="$('#callstype').val('881,6'); $('#callstype_text').text('{_ Long distance calls _}');">{_ Long distance calls _}</li></a>
</ul>
</div>
