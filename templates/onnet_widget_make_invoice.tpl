...
<table id="make_invoice_table" class="table table-hover table-centered table-condensed">
    ...
    <tbody>
        <tr>
            ...
            <td>{% button class="btn btn-xs btn-onnet pull-right" action={postback postback="invoiceme_progress" delegate="onnet"} action={postback postback="invoiceme" delegate="onnet" qarg="invoiceme"} text=_"proceed"%}</td>
        </tr>
    </tbody>
</table>
{% endblock %}
